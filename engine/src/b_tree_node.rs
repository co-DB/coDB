        ...
        match insert_result {
            ...
            InsertResult::NeedsDefragmentation => {
                ...
                match new_response {
                    ...
                    InsertResult::NeedsDefragmentation => Err(BTreeNodeError::CorruptNode {
                        reason: "insert still needs defragmentation after compact_records()"
                            .to_string(),
                    }),
                }
            }
    ...
    Page: PageWrite + PageRead,
{
    ...
    pub fn update_separator_at_slot(
        ...
        if self.slotted_page.is_slot_deleted(slot_id)? {
            return Err(BTreeNodeError::CorruptNode {
                reason: format!("update_separator_at_slot: slot {slot_id} is deleted"),
            });
        }
