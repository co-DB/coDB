...
where
    P: ProtocolHandler,
{
    db_client: DbClient<P>,
    current_input: String,
}

impl<P> ConsoleHandler<P>
where
    P: ProtocolHandler,
{
    ...
    pub fn new(db_client: DbClient<P>) -> Self {
        Self {
            db_client,
    ...
    pub async fn run_loop(&mut self) -> Result<(), ClientError> {
    ...
    fn is_final_message(&self) -> bool {
        match self {
            ...
            Response::Error {
                ...
                error_type,
                ErrorType::Network | ErrorType::InvalidRequest | ErrorType::Catalog
            ),
            _ => true,
        }
    }
